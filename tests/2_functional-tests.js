...
suite('Functional Tests', () => {
    suite('POST request to /api/solve tests', () => {
       ...
       chai.request(server)
        ...
        test("Solve a puzzle with invalid characters: POST request to /api/solve", (done) => {
            const puzzle = '5..913T2.3...8.5.9.9.25..8.68.47.23...95..46.7.4.....5.2.......4..8916..85.72...3';
       chai.request(server)
        .post('/api/solve')
        .send({ puzzle: puzzle, row: 0, col: 0 })
        .end((err, res) => {
        ...
        test("Solve a puzzle with incorrect length: POST request to /api/solve", (done) => {
            const puzzle = '5..9132.3...8.5.9.9.25..8.68.47.23...95..46.7.4.....5.2.......4..8916..85.72...3';
       chai.request(server)
        .post('/api/solve')
        .send({ puzzle: puzzle, row: 0, col: 0 })
        .end((err, res) => {
        ...
        test("Solve a puzzle that cannot be solved: POST request to /api/solve", (done) => {
             const puzzle = '55591372.3...8.5.9.9.25..8.68.47.23...95..46.7.4.....5.2.......4..8916..85.72...3';
       chai.request(server)
        .post('/api/solve')
        .send({ puzzle: puzzle})
        .end((err, res) => {
  ...
  suite("Check POST request to /api/check", () =>{
    ...
    test('Check a puzzle placement with single placement conflict: POST request to /api/check', (done) => {
      ...
      chai.request(server)
        .post('/api/check')
        .send({ puzzle: puzzle, coordinate: 'A1', value: 3 })
        .end((err, res) => {
          assert.equal(res.status, 200);
    ...
    test('Check a puzzle placement with mulitple placement conflict: POST request to /api/check', (done) => {
      const puzzle = '..9..5.1.85.4....2432......1...69.83.9.....6.62.71...9......1945....4.37.4.3..6..';
      chai.request(server)
        .post('/api/check')
        ...
        .end((err, res) => {
          ...
          assert.property(res.body, 'valid');
          assert.equal(res.body.valid, false);
          assert.deepEqual(res.body.conflict, ['column', 'row']);
          done();
        });
    });
    ...
    test('Check a puzzle placement with mulitple placement conflict: POST request to /api/check', (done) => {
      ...
      chai.request(server)
        .post('/api/check')
        .send({ puzzle: puzzle, coordinate: 'A3', value: 9 })
        .end((err, res) => {
          assert.equal(res.status, 200);
          assert.property(res.body, 'conflict');
          assert.property(res.body, 'valid');
    ...
    test('Check a puzzle placement with invalid placement value: POST request to /api/check', (done) => {
      ...
      chai.request(server)
        .post('/api/check')
        .send({ puzzle: puzzle, coordinate: 'E4', value: "T" })
        .end((err, res) => {
          assert.equal(res.status, 200);
          assert.property(res.body, 'error');
